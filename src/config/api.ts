...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    PLAYLIST: {
      ...
      APPROVE_SONG: (eventId: string, songId: string) => `${API_BASE_URL}/api/playlists/events/${eventId}/playlist/approve/${songId}`,
      REJECT_SONG: (eventId: string, songId: string) => `${API_BASE_URL}/api/playlists/events/${eventId}/playlist/reject/${songId}`,
      START_SESSION: (eventId: string) => `${API_BASE_URL}/api/playlists/events/${eventId}/playlist/start`,
      END_SESSION: (eventId: string) => `${API_BASE_URL}/api/playlists/events/${eventId}/playlist/end`,
